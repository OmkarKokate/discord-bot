    ...
    async def rockpaperscissors(self, ctx, *, player_choice):
        ...
        if player_choice in options:
            if player_choice == choice:
                await ctx.reply(f'**Draw!** Bot chose {choice} and you chose {player_choice}')  
            elif player_choice == "rock" and choice == "scissors":
                await ctx.reply(f'**You win!** Bot chose {choice} and you chose {player_choice}')
            elif player_choice == "paper" and choice == "rock":
                await ctx.reply(f'**You win!** Bot chose {choice} and you chose {player_choice}')
            elif player_choice == "scissors" and choice == "paper":
                await ctx.reply(f'**You win!** Bot chose {choice} and you chose {player_choice}')
            else:
                await ctx.reply(f'**You Lose!** Bot chose {choice} and you chose {player_choice}')
        else:
            await ctx.reply(f"Invalid syntax\nUsage: `$rps rock` `$rps paper` `$rps scissors`")
